...
class TAG_Value(ABC):
    """Base class for all Value tag types
    ...
    def __add__(self, other):
        return self.__class__(self.value + self.valueType(other))
    ...
    def value(self, newValue):
        ...
        self._value = self.encode(newValue)
...
class TAG_Array(ABC, MutableSequence):
